      ...
      <div className='container mb-5'>
        ...
        <div className='row'>
          <div className='col-12 col-md-6'>
            <img alt='us image' className='img img-fluid border border-5' src={us}></img>
          </div>
          <div className='col-12 col-md-6'>
            <p className='about-us-text'>Cookstown Antiques is a small family-owned business that specializes in providing customers with unique and high-quality antique pieces. Our passion for antiques started over 25 years ago, and we have since been traveling the globe in search of the finest pieces for our customers. Our collection ranges from vintage furniture, art pieces, and collectibles, all of which are sourced from public antique shows to private European collectors.</p>
            ...
            <p className='about-us-text'>At Cookstown Antiques, we are dedicated to providing our customers with that <i>perfect</i> piece for their home. Whether you are a seasoned collector or new to the world of antiques, we are confident that our collection will leave a lasting impression.</p>
          </div>
        </div>
      </div>
    </div>
